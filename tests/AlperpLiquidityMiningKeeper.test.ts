...
import {
  ...
  AlperpLiquidityMiningKeeper__factory,
  IAlperpFeedableRewarder,
  IAlperpParadeen,
  IERC20,
} from "../typechain";
...
describe("#AlperpLiquidityMiningKeeper", () => {
  let deployer: SignerWithAddress;

  let fakeToken: FakeContract<IERC20>;
  let fakeFeedableRewarder: FakeContract<IAlperpFeedableRewarder>;
  let fakeParadeen: FakeContract<IAlperpParadeen>;
  let keeper: AlperpLiquidityMiningKeeper;
